...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
            ...
            <div id="navbarBasicExample" class="navbar-menu">
                <div class="navbar-start">
                    <div class="box-new" id="menuIcon">
                        <img class="burguer-svg" src="https://raw.githubusercontent.com/k-tw0/visiondigital/3874a770d12ee76809728c4bb45840d690033c0a/public/lol.svg" width="50" height="28">
                        <p class="p-svg-menu">MENÚ</p>
                    </div>
                    <div class="box-search">
                        <img class="search-svg" src="https://raw.githubusercontent.com/k-tw0/visiondigital/3874a770d12ee76809728c4bb45840d690033c0a/public/bx-search.svg" width="50" height="28">
                        <input class="input" type="text" placeholder="BUSCAR">
                    </div>
                </div>

                <img class="img-principal" src="https://raw.githubusercontent.com/k-tw0/visiondigital/main/public/DESKTOP.png" width="50" height="28">
        ...
        <div id="menuContent" class="menu-content">
            ...
            <a href="#" class="menu-item nav-items">Inicio</a>
            <a href="#" class="menu-item nav-items">Ciberseguridad</a>
            <a href="#" class="menu-item nav-items">Inteligencia Artificial</a>
            <a href="#" class="menu-item nav-items">Tecnología</a>
    ...
    <!-- El id: componente. - Es un intermediario para usar React-->
        ...
        <div class="box-img-and-min-noticias">
            <img class="img-noticia-principal" src="{{ $noticia->ruta_imagen }}" width="50" height="28">
            <div class="box-cards-min-show">
                <div class="card-dimiuta-noticia">
                    ...
                    @if($publicacionMasVista)
                        ...
                        <div class="box-min-not">
                            <img class="img-article-not" src="{{ $publicacionMasVista->ruta_imagen }}" width="50" height="28">
                ...
                <div class="card-dimiuta-noticia">
                    ...
                    @if($segundaPublicacionMasVista)
                        ...
                        <div class="box-min-not">
                            <img class="img-article-not" src="{{ $segundaPublicacionMasVista->ruta_imagen }}" width="50" height="28">
                            <div class="card-article-min-noticia">
